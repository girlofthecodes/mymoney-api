...
urlpatterns = [
    ...
    path('auth/user/', views.UserDataView.as_view(),),
    ...
    path('auth/validate-password/', views.ValidateCurrentPasswordAPIView.as_view(),),
    path('auth/change-password/', views.ChangeNewPasswordAPIView.as_view(), name="change-password"), 
